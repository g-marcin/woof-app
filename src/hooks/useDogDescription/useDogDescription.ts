...
const fetchBreedDescription = async (breedName: string): Promise<DescriptionDTO['message']> => {
    const response = await httpClient.get<DescriptionDTO>(`/breed/${breedName}/description`);
