...
export const ModeNavigation: FC = () => {
    ...
    const baseButtonClass =
        'bg-transparent border-2 border-[color:var(--secondary)] rounded-lg cursor-pointer transition-all duration-300 no-underline text-[color:var(--typography-tertiary)] hover:bg-[color:var(--secondary)] max-md:px-4 max-md:py-2'
    const activeClass =
        'bg-[color:var(--secondary)] border-[color:var(--link-active)] shadow-[0_2px_8px_rgba(0,0,0,0.1)]'
        ...
        <div className="flex gap-2.5 justify-center py-5 border-b-2 border-[color:var(--secondary)] mb-5 max-md:flex-wrap max-md:gap-2">
            <button
                ...
                className={`primary ${baseButtonClass} ${
                    currentMode === ModeType.DETAILS
                        ? `${activeClass} typography-primary`
