...
export const DogSearchContext = createContext<DogSearchContextType>([
    '',
    () => {},
] as unknown as DogSearchContextType)

export const DogSearchContextProvider: FC<PropsWithChildren> = ({
    children,
}) => {
